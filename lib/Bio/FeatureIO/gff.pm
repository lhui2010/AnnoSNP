...
my $RESERVED_TAGS   = "ID|Name|Alias|Parent|Target|Gap|Derives_from|Note|Dbxref|dbxref|Ontology_term|Index|CRUD|Sequence_download|Locus_id|Transcript_evidence|Status|Gene_symbols|References|NIAS_FLcDNA|ORF_evidence|Link_to|KEGG|InterPro|GO|Expression|Species|Comment|EST_evidence|Homolog|PGFD";
...
sub _handle_feature {
  ...
  foreach my $other_canonical (qw(Alias Parent Note Derives_from Index CRUD GO Link_to InterPro)){
...
sub organism {
    my $self = shift;
    my $organism = shift;# if defined(@_); #annotated for the warning deprecated message 
